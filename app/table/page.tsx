...
export default function TablePage() {
  ...
  // State to manage your UI dropdowns and modals since we don't use vanilla JS click listeners anymore
    ...
    <div className="page-container">
      ...
      <header className="header">
        ...
        <div className="dropdown" id="userDropdown">
          ...
          <div className={`dropdown-content user-dropdown ${showUserMenu ? 'show' : ''}`} id="userPanel">
            <a href="#" style={{ display: 'block', padding: '8px', textDecoration: 'none', color: '#333' }}>Profile</a>
            <a 
              href="#" 
              id="logoutBtn" 
              style={{ display: 'block', padding: '8px', textDecoration: 'none', color: 'red', borderTop: '1px solid #eee' }}
              onClick={(e) => { e.preventDefault(); setShowLogoutModal(true); setShowUserMenu(false); }}
            >
              Logout
            </a>
          </div>
      ...
      {/* --- LOGOUT MODAL --- */}
      <div id="logoutModal" className={`modal-overlay ${showLogoutModal ? 'show' : ''}`}>
        <div className="modal-box">
          <p>Are you sure you want to logout?</p>
          <div className="modal-buttons">
            <button id="confirmLogout" className="modal-btn yes" onClick={handleLogout}>YES</button>
            <button id="cancelLogout" className="modal-btn no" onClick={() => setShowLogoutModal(false)}>NO</button>
          </div>
        </div>
      </div>
        ...
        <div className="dropdown" id="filterDropdown">
          ...
          <div className={`dropdown-content filter-dropdown ${showFilterMenu ? 'show' : ''}`} id="mainFilterPanel">
            ...
            <div className="filter-category">
              ...
              <div className={`category-checklist ${openCategory === 'barangay' ? 'show' : ''}`} id="barangay-checklist">
            ...
            <div className="filter-category">
              ...
              <div className={`category-checklist ${openCategory === 'gender' ? 'show' : ''}`} id="gender-checklist">
            ...
            <div className="filter-category">
              ...
              <div className={`category-checklist ${openCategory === 'religion' ? 'show' : ''}`} id="religion-checklist">
                ...
                <div className="others-row">
                  <input type="text" placeholder="others:" id="relOthersInput" />
                  <button style={{ background: '#e0d4f0', border: 'none', borderRadius: '20px', padding: '5px 12px', fontSize: '0.8rem', cursor: 'pointer' }} id="addOthersBtn">➕</button>
                </div>
              </div>
            </div>

            {/* IP MEMBERSHIP FILTER */}
            <div className="filter-category">
              <div className="category-header" onClick={() => toggleCategory('ip')}>
                <span>IP Membership</span>
                <span className="category-indicator">▼</span>
              </div>
              <div className={`category-checklist ${openCategory === 'ip' ? 'show' : ''}`} id="ipmembership-checklist">
            ...
            <div className="filter-category">
              ...
              <div className={`category-checklist ${openCategory === 'education' ? 'show' : ''}`} id="educational-checklist">
            ...
            <div className="filter-category">
              ...
              <div className={`category-checklist ${openCategory === 'disability' ? 'show' : ''}`} id="disability-checklist">
            ...
            <div className="filter-category">
              ...
              <div className={`category-checklist ${openCategory === 'illness' ? 'show' : ''}`} id="illness-checklist">
          ...
          <tbody id="dataTable">
            {profiles.length === 0 ? (
              ...
              profiles.map((profile) => {
                ...
                // Replicating your table.js Date calculation logic
                ...
                return (
                  <tr key={profile.id}>
                    ...
                    <td>
                      <button className="check-btn" onClick={() => router.push(`/profile?id=${profile.id}`)}>
                        Check Information
                      </button>
                    </td>
                  </tr>
