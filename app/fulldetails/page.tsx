...
setTimeout(() => router.push('/table'), 1500);
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
        const finalData = {
            ...formData,
            name: formData.r1_name || "", address: formData.r2_address || "", contact: formData.r3_contact || "", birthday: formData.r4_dob || "",
...
setTimeout(() => setNotification(null), 4000);
  ...
  if (isLoadingData) return <div style={{ padding: '100px', textAlign: 'center', fontSize: '20px', fontFamily: 'Arial' }}>Loading Profile Data...</div>;
  ...
  >
    {notification.message}
        ...
        <div className="container-right">
            ...
            <button type="button" className="update-btn" onClick={handleSubmit}>{isSaving ? "UPDATING..." : "UPDATE"}</button>
            <button type="button" className="delete-btn" onClick={() => setShowDeleteModal(true)}>DELETE</button>
        </div>
            ...
            {currentStep === 2 && (
              <div className="step-2 animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <div className="form-section">
                    ...
                    {["Own house and lot", "Own house, rent-free lot without consent of owner", "Own house, rent-free lot with the consent of the owner", "Rent-free house and lot without consent of owner", "Rent-free house and lot with consent of owner", "Rented house and lot for less than three years", "Own house, rented lot for less than three years", "Other"].map((opt, i) => (
                        <label className="radio-option" key={i}>
                            ...
                            {opt === "Other" && <input type="text" name="house_lot_other" className="line-input" disabled={val("house_lot") !== "Other"} value={val("house_lot_other")} onChange={handleChange} />}
                        </label>
                    ))}
                    ...
                    {["Electric Company", "Generator", "Solar", "Battery", "Others", "None"].map((opt, i) => (
                        <label className="radio-option" key={i}>
                            ...
                            {opt === "Others" && <input type="text" name="electricity_specify" className="line-input" disabled={val("main_source_of_electricity") !== "Others"} value={val("electricity_specify")} onChange={handleChange} />}
                        </label>
                    ))}
                    ...
                    {["Unprotected spring, lake, river, rain, dug well", "Commercial sources, e.g., tanker, truck, peddler (except bottled water)", "Source of safe drinking water but the time to collect water including the time to walk to the water source, collect it and return is longer than 30 minutes.", "Own use of faucet community water system (gripo)", "Shared faucet community water system", "Own use tubed/piped deep well", "Shared tubed/ piped deep well, tubed/piped shallow well", "Bought bottled water including those being delivered", "Others"].map((opt, i) => (
                        <label className="radio-option" key={i}>
                            ...
                            {opt === "Others" && <input type="text" name="water_supply_specify" className="line-input" disabled={val("water_supply") !== "Others"} value={val("water_supply_specify")} onChange={handleChange} />}
                        </label>
                    ))}
                    ...
                    {["Water-sealed, sewer septic tank, used exclusively by the family", "Water-sealed, sewer septic tank, shared with other families", "Closed pit", "Open pit", "Others", "None"].map((opt, i) => (
                        <label className="radio-option" key={i}>
                            ...
                            {opt === "Others" && <input type="text" name="sanitation_specify" className="line-input" disabled={val("sanitation") !== "Others"} value={val("sanitation_specify")} onChange={handleChange} />}
                        </label>
                    ))}
                    ...
                    {["Garbage collection", "Burning", "Composting", "Recycling", "Waste Segregation", "Pit with cover", "Pit without cover", "Throwing of garbage in rivers, vacant lots, etc.", "Others"].map((opt, i) => (
                        <label className="radio-option" key={i}>
                            ...
                            {opt === "Others" && <input type="text" name="garbage_disposal_specify" className="line-input" disabled={val("garbage_disposal") !== "Others"} value={val("garbage_disposal_specify")} onChange={handleChange} />}
                        </label>
                    ))}
                </div>
                ...
                <div className="form-section">
                    ...
                    <table className="health-table">
                        <tbody>
                            ...
                            <tr><td colSpan={2}><b>OVER-ALL TOTAL</b></td><td><input type="text" name="overall_total" readOnly value={val("overall_total")} style={{ backgroundColor: "#e9ecef" }} /></td><td></td></tr>
                        </tbody>
                    </table>
                ...
                <div className="form-section">
                    ...
                    <label className="radio-option"><input type="checkbox" name="reason_for_unemployment" value="Lack of skills" checked={val("reason_for_unemployment").includes("Lack of skills")} onChange={handleCheckboxChange} /> Lack of skills</label>
                    <label className="radio-option"><input type="checkbox" name="reason_for_unemployment" value="Health reasons" checked={val("reason_for_unemployment").includes("Health reasons")} onChange={handleCheckboxChange} /> Health reasons</label>
                    <label className="radio-option"><input type="checkbox" name="reason_for_unemployment" value="Caregiving responsibilities" checked={val("reason_for_unemployment").includes("Caregiving responsibilities")} onChange={handleCheckboxChange} /> Caregiving responsibilities</label>
                    <label className="radio-option"><input type="checkbox" name="reason_for_unemployment" value="Others" checked={val("reason_for_unemployment").includes("Others")} onChange={handleCheckboxChange} /> Others. Specify: <input type="text" className="line-input" style={{ marginLeft: '10px' }} name="unemployment_reason_specify" disabled={!val("reason_for_unemployment").includes("Others")} value={val("unemployment_reason_specify")} onChange={handleChange} /></label>
                </div>
                ...
                <div className="form-section">
                    ...
                    <label className="radio-option"><input type="radio" name="financial_assistance" value="Yes" checked={val("financial_assistance") === "Yes"} onChange={handleChange} /> a. Yes. Specify: <input type="text" className="line-input" name="financial_assistance_specify" disabled={val("financial_assistance") !== "Yes"} value={val("financial_assistance_specify")} onChange={handleChange} /></label>
                    ...
                    <label className="radio-option"><input type="radio" name="social_services" value="Yes" checked={val("social_services") === "Yes"} onChange={handleChange} /> a. Yes. Specify: <input type="text" className="line-input" name="social_services_specify" disabled={val("social_services") !== "Yes"} value={val("social_services_specify")} onChange={handleChange} /></label>
                    ...
                    <label className="radio-option"><input type="radio" name="availed_any_services" value="Yes" checked={val("availed_any_services") === "Yes"} onChange={handleChange} /> a. Yes. Specify: <input type="text" className="line-input" name="availed_services_specify" disabled={val("availed_any_services") !== "Yes"} value={val("availed_services_specify")} onChange={handleChange} /></label>
                    ...
                    <label className="radio-option"><input type="checkbox" name="challenges_faced" value="Lack of information" checked={val("challenges_faced").includes("Lack of information")} onChange={handleCheckboxChange} /> Lack of information</label>
                    <label className="radio-option"><input type="checkbox" name="challenges_faced" value="Distance and transportation" checked={val("challenges_faced").includes("Distance and transportation")} onChange={handleCheckboxChange} /> Distance and transportation</label>
                    <label className="radio-option"><input type="checkbox" name="challenges_faced" value="Financial constraints" checked={val("challenges_faced").includes("Financial constraints")} onChange={handleCheckboxChange} /> Financial constraints</label>
                    <label className="radio-option"><input type="checkbox" name="challenges_faced" value="Prejudice and discrimination" checked={val("challenges_faced").includes("Prejudice and discrimination")} onChange={handleCheckboxChange} /> Prejudice and discrimination</label>
                    <label className="radio-option"><input type="checkbox" name="challenges_faced" value="Others" checked={val("challenges_faced").includes("Others")} onChange={handleCheckboxChange} /> Others. Specify: <input type="text" className="line-input" style={{ marginLeft: '10px' }} name="challenges_faced_specify" disabled={!val("challenges_faced").includes("Others")} value={val("challenges_faced_specify")} onChange={handleChange} /></label>
                </div>
      ...
      <div id="deleteModal" className={`modal-overlay ${showDeleteModal ? 'show' : ''}`}>
          <div className="modal-box">
              <p>Are you sure you want to<br/>delete the record?</p>
              <div className="modal-buttons">
                  <button id="confirmDeleteBtn" className="modal-btn yes" onClick={handleDelete}>Yes</button>
                  <button id="cancelDeleteBtn" className="modal-btn no" onClick={() => setShowDeleteModal(false)}>No</button>
              </div>
          </div>
      </div>
